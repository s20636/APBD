...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> r1 = from e in Emps
                     where e.Job == "Backend programmer"
                                  select e;

            IEnumerable<Emp> r2 = Emps.Where(e => e.Job == "Backend programmer");
        ...
        {
            IEnumerable<Emp> r1 = Emps.Where(e => e.Job == "Frontend programmer" && e.Salary > 1000)
          .OrderBy(e => e.Ename);
            return r1;
        }
        ...
        {
            return Emps.Where(e => e.Salary == Emps.Max(e => e.Salary));
        }
        ...
        {
            var r1 = from e in Emps
                     join e2 in Depts on e.Deptno equals e2.Deptno
                     select new { e.Ename, e.Job, e2.Dname };
            return r1;
        }
        ...
        public static IEnumerable<object> Task7()
        {
            ...
            var r1 = (from e in Emps
                     group e by e.Job into newGroup
                     select new { Praca = newGroup.Key, LiczbaPracownikow = newGroup.Count()}).ToList();     
            return r1;
        }
        ...
        {
            return Emps.Where(e => e.Job.Equals("Frontend programmer")).OrderBy(e => e.HireDate).Last();
        }
        ...
        {
            var r1 = Emps.Select(e => new {e.Ename, e.Job, e.HireDate}).Union(
